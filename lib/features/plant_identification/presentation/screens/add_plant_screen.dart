        ...
        data: (result) {
          if (result != null) {
             ...
             final plantMap = {
               ...
               'origin': 'Unknown', 
               'watering': result.watering ?? 'Check plant database',
               'maintenance': result.description != null ? 'See detailed care guide' : 'Check plant database',
               'care_level': result.hardiness ?? 'Moderate',
               'water': 50,
               'light': 50,
               'sunlight': result.sunlight ?? 'Bright indirect light',
               'pruning': result.pruningMonth,
               'hardiness': result.hardiness,
               'description': result.description,
               'careInstructions': result.careInstructions,
               'cycle': result.cycle,
               'growthRate': result.growthRate,
               'poisonousToHumans': result.poisonousToHumans,
               'poisonousToPets': result.poisonousToPets,
               'droughtTolerant': result.droughtTolerant,
